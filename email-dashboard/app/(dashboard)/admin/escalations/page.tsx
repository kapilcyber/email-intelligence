...
import { AlertCircle, ArrowLeft, Download, Info, Table2, Users, Tags } from "lucide-react";
                ...
                <table className="w-full text-left text-sm">
                  <thead className="border-b border-neutral-200 bg-neutral-50 dark:border-neutral-700 dark:bg-neutral-800/50">
                    <tr>
                      ...
                      <th className="px-4 py-3 font-semibold text-neutral-900 dark:text-neutral-50">Escalation count</th>
