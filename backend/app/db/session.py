...
""",
    ...
    "ALTER TABLE team_projects ADD COLUMN IF NOT EXISTS tracker_member_deadline_days JSONB NULL",
    "ALTER TABLE team_projects ADD COLUMN IF NOT EXISTS tracker_member_schedule_days JSONB NULL",
]
